...
![Neodeol의 와이드 전장, 파쇄탄 착탄 효과와 포탄 관측경](docs/images/battlefield-effects.png)
...
전투 연출은 금속 탄체·탄대·안정핀으로 구분한 **8종 포탄**, 방향을 따라 흐르는 바람·능선 먼지,
포구 화염·지형 반사광·착탄 충격파·후속 연무로 구성합니다. 탱크는 장갑 디테일과 가독성을 위해
시각적으로 12% 확대했으며 충돌 크기와 탄도는 그대로입니다. 무기 카드와 관측경도 같은 포탄 모델을 사용합니다.
운영체제의 동작 줄이기 설정에서는 화면 섬광·반동·대기 애니메이션을 생략합니다.
