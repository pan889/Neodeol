...
작전은 입문(시드 85, 2인, 쉬움), 표준(시드 149, 3인, 보통), 도전(시드 221, 4인, 어려움)의
...
전체 맵에서 작은 탱크의 디테일을 볼 수 있도록 전장 하단에 접을 수 있는 4배 관측경을 둔다.
현재 활성 탱크와 주변 실제 렌더 결과만 확대하며 예상 탄도나 숨겨진 정보를 추가하지 않는다.
