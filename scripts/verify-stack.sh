...
if node --test client/tests/operations.mjs client/tests/operations-integration.mjs client/tests/battlefield-art.mjs client/tests/scope-camera.mjs client/tests/ai-difficulty.mjs client/tests/flight-playback.mjs client/tests/wind.mjs; then
